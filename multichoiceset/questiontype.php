...
class qtype_multichoiceset extends question_type {
    ...
    public function save_question_options($question) {
        ...
        $options->our_qtype=$question->our_qtype;
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        $question->our_qtype = $questiondata->options->our_qtype;
    ...
    public static function get_qtype_list(){
        $values = array();
        $values["multi"]="multi choice";
        $values["tf"]="true/false";
        return $values;
    }
